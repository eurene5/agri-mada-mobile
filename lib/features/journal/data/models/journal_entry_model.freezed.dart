...
class _$JournalEntryModelImpl implements _JournalEntryModel {
  ...
  @override
  String toString() {
    return 'JournalEntryModel(id: $id, imagePath: $imagePath, diseaseName: $diseaseName, scientificName: $scientificName, confidence: $confidence, severity: $severity, recommendations: $recommendations, createdAt: $createdAt)';
  }
...
abstract class _JournalEntryModel implements JournalEntryModel {
  const factory _JournalEntryModel(
      ...
      required final List<String> recommendations,
      required final DateTime createdAt}) = _$JournalEntryModelImpl;
